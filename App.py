...
class App(object):
    ...
    def open_image_button_click(self):
        self.file_name = filedialog.askopenfilename(initialdir = "D:\Download\EnglishFnt\EnglishFnt\English\Fnt",title = "Choose image",filetypes = (("png files","*.png"),("all files","*.*")))
